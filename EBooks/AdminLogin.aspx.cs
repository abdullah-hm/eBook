    ...
    public partial class AdminLogin : System.Web.UI.Page
    {
        ...
        private bool isvalidlogin()
        {
            if (txtemail.Text.Trim() == string.Empty)
            {
                ...
                Response.Write("<script> alert('Admin Email ID is required!'); </script>");
                return false;
            }
            ...
            {
                Response.Write("<script> alert('Admin Password is required!'); </script>");
                return false;
            }
            return true;
        }
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            if (isvalidlogin())
            {
                ...
                try
                {
                    String login_querry = "SELECT * FROM admin WHERE email ='" + email + "' AND password ='" + password + "' ";
